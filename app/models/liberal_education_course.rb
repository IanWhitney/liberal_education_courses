class LiberalEducationCourse < ActiveRecord::Base
  self.table_name = "ps_crse_catalog"
  ...
  def self.retrieve_from_db(where_clause)
    sql = <<EOS
      ...
      from
        ps_crse_catalog crse
        left join ps_crse_attributes diversified_core_courses
        on
        ...
        left join ps_crse_attributes designated_theme_courses
        on
        ...
        left join ps_crse_attributes writing_intensive_courses
        on
        ...
        inner join ps_crse_offer offer
        on
